...
```
docker run -d --name client-postgres --publish published=9500,target=80 -e PGADMIN_DEFAULT_PASSWORD=54321 -e PGADMIN_DEFAULT_EMAIL=gbusingo@gmail.com --network net-drupal dpage/pgadmin4
```
...
```
docker run -d --name server-drupal --publish published=9700,target=80 -v drupal-html:/var/www/html -v drupal-modules:/var/www/html/modules -v drupal-themes:/var/www/html/themes -v drupal-files:/var/www/html/sites --network net-drupal drupal
```
